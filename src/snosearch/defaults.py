...
DEFAULT_RANGE_AGGREGATION_KWARGS = [
    'ranges',
]

DEFAULT_DATE_HISTOGRAM_AGGREGATION_KWARGS = [
    'calendar_interval',
    'format',
]

DEFAULT_DATE_HISTOGRAM_CALENDAR_INTERVAL = 'month'

DEFAULT_DATE_HISTOGRAM_DATE_FORMAT = 'yyyy-MM-dd'

ADDITIONAL_FACET_FIELDS = [
    'category',
    'description',
    'optional',
]
